...
public class SnippetPairTest {
	...
	public static void init() {
		snippetPair = new SnippetPair("a.c", "b.c", "Here's some text", "Here's some text.");
	}
	...
	public void constructorNullFileName1() {
		SnippetPair snippetPair = new SnippetPair(null, "b.c", "Here's some text", "Here's some text.");
	}
	...
	public void constructorNullFileName2() {
		SnippetPair snippetPair = new SnippetPair("a.c", null, "Here's some text", "Here's some text.");
	}
	...
	public void constructorNullSnipet1() {
		SnippetPair snippetPair = new SnippetPair("a.c", "b.c", null, "Here's some text.");
	}
	...
	public void constructorNullSnipet2() {
		SnippetPair snippetPair = new SnippetPair("a.c", "b.c", "Here's some text", null);
	}
}